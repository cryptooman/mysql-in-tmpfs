...
#
# Run detached MySQL instance with data folder in RAM (tmpfs), i.e. based completely in memory
# The purpose is to increase execution speed of MySQL based application unit tests with minimal efforts
#
# Usage:
# Run as sudo: sudo bash mysql-in-tmpfs.sh
# Connect your application unit tests to the created mysqld instance
#
...
#
# WARNING: ALL MYSQL TEMP DATA WILL BE LOST ON SERVER REBOOT / SHUTDOWN OR ACCIDENTAL POWER LOST
# ====================================
...
echoDt ""
echoDt "WARNING: ALL MYSQL TEMP DATA WILL BE LOST ON SERVER REBOOT / SHUTDOWN OR ACCIDENTAL POWER LOST"
echoDt ""
